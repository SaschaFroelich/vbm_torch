...
param_names, _, _, er_day2, extra_storage_day2, \
_, agent_elbo_tuple_day2, _ = utils.load_data(inftype ='bothdays')

#%%
model = complete_df_all['model'].unique()[0]
hue_order = ['Random', 'Congruent', 'Incongruent']

if 'theta_conflict' in param_names:
    param1 = 'theta_rep'
...
rday1, p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day']==1]['RT_diff_stt'], 
                           complete_df_all[complete_df_all['day']==1]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 1: r={rday1}, p={p}")

rday2, p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day']==2]['RT_diff_stt'], 
                           complete_df_all[complete_df_all['day']==2]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 2: r={rday2}, p={p}")

" Correlation difference between days 1 and 2. "
utils.correlation_difference_test(rday1, 60, rday2, 60)

"Test Corr ΔRT ~ ΔCI (Cong-Inc) by age using a median-split"
old_df = complete_df_all[complete_df_all['age'] >= complete_df_all['age'].median()]
young_df = complete_df_all[complete_df_all['age'] < complete_df_all['age'].median()]

rday1_old, p = scipy.stats.pearsonr(old_df[old_df['day']==1]['RT_diff_stt'], 
                           old_df[old_df['day']==1]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 1 Old: r={rday1_old}, p={p}")

rday2_old, p = scipy.stats.pearsonr(old_df[old_df['day']==2]['RT_diff_stt'], 
                           old_df[old_df['day']==2]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 2 Old: r={rday2_old}, p={p}")

rday1_young, p = scipy.stats.pearsonr(young_df[young_df['day']==1]['RT_diff_stt'], 
                           young_df[young_df['day']==1]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 1 Young: r={rday1_young}, p={p}")

rday2_young, p = scipy.stats.pearsonr(young_df[young_df['day']==2]['RT_diff_stt'], 
                           young_df[young_df['day']==2]['CIspread'])
print(f"Correlation ΔRT vs CIspread, Day 2 Young: r={rday2_young}, p={p}")

utils.correlation_difference_test(rday1_old, 30, rday1_young, 30)
utils.correlation_difference_test(rday2_old, 30, rday2_young, 30)
...
'''
    Corr ER ~ ΔCI
'''
rday1,p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day']==1]['ER_diff_stt'], 
                           complete_df_all[complete_df_all['day']==1]['CIspread'])
print(f"Correlation ΔER vs CIspread, Day 1: r={r}, p={p}")

rday2,p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day']==2]['ER_diff_stt'], 
                           complete_df_all[complete_df_all['day']==2]['CIspread'])
...
r,p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day'] == 1]['CIspread'], 
                           complete_df_all[complete_df_all['day'] == 1]['hpcf_rand'])

print(f"Pearson corr CI vs HRC Baseline on Day 1: r={r}, p={p}.")

r,p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day'] == 2]['CIspread'], 
                           complete_df_all[complete_df_all['day'] == 2]['hpcf_rand'])

print(f"Pearson corr CI vs HRC Baseline on Day 2: r={r}, p={p}.")
...
r,p = scipy.stats.spearmanr(complete_df_all[complete_df_all['day'] == 2]['theta_rep'],
                           complete_df_all[complete_df_all['day'] == 2]['CRspread'])
print(f"Spearman, θ_Rep vs CRspread r={r}, p={p}")

r,p = scipy.stats.spearmanr(complete_df_all[complete_df_all['day'] == 2]['theta_rep'],
                           complete_df_all[complete_df_all['day'] == 2]['CIspread'])
print(f"Spearman, θ_Rep vs CIspread r={r}, p={p}")

r,p = scipy.stats.spearmanr(complete_df_all[complete_df_all['day'] == 2]['theta_rep'],
                           complete_df_all[complete_df_all['day'] == 2]['RIspread'])
print(f"Spearman, θ_Rep vs RIspread r={r}, p={p}")
...
r,p = scipy.stats.pearsonr(complete_df_all[complete_df_all['day'] == 1]['theta_Q'],
                           complete_df_all[complete_df_all['day'] == 1]['theta_rep'])
print(f"Pearson betwen θ_Q & θ_Rep r={r}, p={p}")
...
errors_waic = [289.4, 289.3, 187, 100, 100, 100]

df = pd.DataFrame({'WAIC': {0: 43497.6, 
                           1: 43391.2, 
                           2: 19939, 
                           3: 40000, 
                           4: 40000, 
                    ...
                    'DIC': {0: 19997, 
                            ...
                            4: 20561, 
                            5: 20316},
                      'Model_Names': {0: u'M 1',1: u'M 2',2: u'M 3',3: u'M 4', 
                                      4: u'M 5', 5: u'M 6'}})
...
complete_df, inf_mean_df, expdata_df_temp, post_sample_df, sim_df, \
param_names, _, _, er, extra_storage, _, agent_elbo_tuple, _ = utils.load_data(inftype='bothdays')