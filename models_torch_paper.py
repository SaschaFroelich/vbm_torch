...
class Vbm_2days_nolr(Vbm):
    ...
    def pars_to_locs(self, df):
        ...
        locs[:, 3] = torch.logit(torch.tensor(param_dict['omega_day2']))
        locs[:, 4] = torch.log(torch.tensor(param_dict['dectemp_day2']))
...
class Seqboost_2days_nlor(Repbias_2days_nolr):
...
class Handedness_2days_nolr(Repbias_2days_nolr):
...
class Conflict_2days_nolr(Repbias_2days_nolr):
...
class CongConflict_2days_nolr(Repbias_2days_nolr):
...
class OnlyR_2days_nolr(Repbias_2days_nolr):
